...
export default function ResumePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F111A] text-white p-8 overflow-y-auto">
        ...
        <div className="mb-8 border-b border-gray-800 pb-6 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">
              Profile Setup & Resume Analysis
            </h1>
            <p className="text-[#9CA3AF] text-sm mt-1">
              Configure your target metrics and upload your resume for a reality
              check.
            </p>
          </div>
        </div>
            ...
            <div className="bg-[#1A1D27] border border-gray-800 rounded-xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${file ? "bg-[#8B5CF6] text-white" : "bg-gray-800 text-gray-500"}`}
                  >
                    1
                  </div>
                  <span
                    className={`text-sm ${file ? "text-white" : "text-gray-500"}`}
                  >
                    Resume Uploaded
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div
                    className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${report ? "bg-[#8B5CF6] text-white" : "bg-gray-800 text-gray-500"}`}
                  >
                    2
                  </div>
                  <span
                    className={`text-sm ${report ? "text-white" : "text-gray-500"}`}
                  >
                    Analysis Complete
                  </span>
                </div>
